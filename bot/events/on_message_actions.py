...
class OnMessageActions():
    ...
    def eventListener(self):
        ...
        async def on_message(message):
            ...
            poe1_trade_site_url = 'www.pathofexile.com/trade/'
            ...
            # POE2 Pricecheck channel message check
            if message.channel.id == poe2_price_check_channel_id:
            ...
            # POE1 Pricecheck channel message check
            if message.channel.id == poe1_price_check_channel_id:
                if message.attachments and poe1_trade_site_url not in msg_content:
                    embed=discord.Embed (
                        title="Your message was deleted!", 
                        description=f'{msg_mention} Please provide a valid trade link + screenshot of your item to get a price check.', 
                        color=0xff0000
